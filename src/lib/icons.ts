/**
 * Lucide icons — export names match lucide-react exactly (Settings, Truck, RefreshCcw, …).
 * Import from here instead of `lucide-react` in feature code.
 * Catalog: `src/lib/icons.catalog.md`
 */
...
export const ArrowLeftRight = createIcon(LucideArrowLeftRight, "ArrowLeftRight");
...
export const CheckCircle2 = createIcon(LucideCheckCircle2, "CheckCircle2");
export const CheckSquare = createIcon(LucideCheckSquare, "CheckSquare");
